...
//Создайте массив с элементами 'a', 'b' и 'c'. Выведите его на экран
...
//Давайте обратимся к несуществующему элементу, например, к элементу с номером 10:
...
//чтобы обратиться к элементу со строковым ключом, в квадратных скобках его уже нужно брать в кавычки
...
//строки, могут содержать внутри себя дефис, пробел и тому подобные вещи,
//и это на самом деле является допустимыми ключами, но только если их взять в кавычки
...
//Дан объект. Найдите сумму его элементов.
...
/***********************************************
 *                                             *
 * -----20----Типизация массивов и объектов--- *
 *                                             *
 * *********************************************
 */
...
/***********************************************
 *                                             *
 * -----23-----Оператор delete в JavaScript--- *
 *                                             *
 * *********************************************
 */
//Не запуская код, определите, что выведется в консоль
...
/***********************************************
 *                                             *
 * ----24-Константы с массивами или объектами- *
 *                                             *
 * *********************************************
 */
...
//Если переменная num больше или равна 10 и меньше или равна 20, то выведите на экран слово 'верно',
...
//Если переменная num1 равна или меньше 1, а переменная num2 больше или равна 3, то выведите на экран слово 'верно',
//иначе выведите слово 'неверно'.
let num1 = 5;
let num2 = 5;
if (num1 <= 1 && num >= 3) {
 ...
 * *********************************************
 */
//условие такое: num должно быть от 0 до 5
if (num > 0 && num < 5) {
  alert("верно");
} else {
  alert("неверно");
}
//Давайте инвертируем - num должно быть меньше или равно 0 ИЛИ больше или равно 5:
if (num <= 0 || num >= 5) {
  alert("верно");
} else {
  alert("неверно");
...
//достаточно поставить знак ! перед изначальным условием - и оно инвертируется само
if (!(num > 0 && num < 5)) {
  alert("верно");
} else {
  alert("неверно");
...
if (day >= 1 && day <= 10) {
  ...
  alert("Ошибка! Введите правильный день!");
}
...
//выполнить проверку возраста на достижение 18 лет.
let age = 17;
let adult;
...
/***********************************************
 *                                             *
 * --34-----Примеры использования if-else----- *
 *                                             *
 * *********************************************
 */
...
//которое проверит, что в массиве 3 элемента. Если это так, выведите на экран сумму элементов массива.
let arr = [1, 2, 3];
if (arr.length === 3) {
  console.log(arr[0] + arr[1] + arr[2]);
}
...
//равен ли первый символ этой строки числу 1:
let str = "12345";
...
//проверить первую цифру на то, что она равна 1, либо 2
let num = 12345;
...
let lastNum = Number(str[lengthStr]);
console.log(lastNum);
...
//Пусть в переменной num хранится число. Определите, четное число или нет. Число будет четным,
//если последний символ равен 0, 2, 4, 6 или 8, и нечетным в противном случае.
...
/***********************************************
 *                                             *
 * ----35-----Практика на условия if-else----- *
 *                                             *
 * *********************************************
 */
...
//выведем столбец четных чисел от 2 до 10
let i = 2;
...
/***************************************************
 *                                                 *
 * -41-Ошибки начинающих при работе с циклом while *
 *                                                 *
 * *************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------56----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------57----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------58----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------59----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------60----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------61----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------62----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------63----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------64----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------65----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------66----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------67----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------68----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
...
/*****************************************************************************
 *                                                                           *
 *   --------69----------  Формирование строк через циклы  ----------------
 *                                                                           *
 * ***************************************************************************
 */
